      ...
      <div className="mx-auto max-w-[1120px] px-3 pb-3 sm:px-5 sm:pb-5">
        ...
        >
          <div className="relative flex shrink-0 items-center">
            ...
            <span className="absolute -right-1.5 -top-1.5 flex size-[18px] items-center justify-center rounded-full bg-yellow text-[0.6rem] font-bold text-black animate-[popIn_0.3s_cubic-bezier(0.22,1,0.36,1)] sm:size-5 sm:text-[0.65rem]">
              {itemCount}
            </span>
          </div>
