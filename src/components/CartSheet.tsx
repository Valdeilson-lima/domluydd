        ...
        {cart.length > 0 && (
          <div className="shrink-0 border-t border-white/8 px-5 py-4 pb-6">
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:gap-2">
              <button
                onClick={onClose}
                className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-[10px] border-2 border-white/10 bg-transparent px-4 py-2.5 font-body text-xs font-bold text-white transition-all duration-200 hover:border-white/30 active:scale-[0.98] sm:flex-1 sm:py-3 sm:text-sm"
              >
                + Adicionar mais
              </button>
              <button
                onClick={onCheckout}
                className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-[10px] bg-[#25d366] px-4 py-2.5 font-body text-xs font-bold text-white transition-all duration-200 hover:bg-[#1da851] active:scale-[0.98] sm:flex-[2] sm:py-3 sm:text-sm"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
