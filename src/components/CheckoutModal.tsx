      ...
      >
        <div className="w-full max-w-[480px] max-h-[90vh] overflow-y-auto rounded-[20px] border border-white/6 bg-black-light shadow-lg animate-[modalIn_0.3s_ease]">
          ...
          <div className="px-6 pb-6 pt-[18px] space-y-5">
            ...
            <button
              onClick={handleSend}
              className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-[8px] bg-[#25d366] px-4 py-3 font-body text-sm font-bold text-white transition-all duration-200 hover:bg-[#1da851] hover:-translate-y-0.5 active:translate-y-0 sm:gap-2.5 sm:py-4 sm:text-base"
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
